...
export default function Options({
    ...
    return (
        <div>
            <button
                className="h-9 flex px-4 text-white font-sfr capitalize text-[.95rem] tracking-wider gap-2 rounded-xl bg-rose-700 hover:bg-rose-600"
            ...
            >
                ...
                >
                    <Link
                        href="/account/library?status=draft"
                        className="text-[.9rem]"
                    >
                        Choose from drafts
                        <svg
