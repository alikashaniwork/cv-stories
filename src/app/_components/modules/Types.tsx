    ...
    return (
        status !== "following" && (
            <div className="w-full md:w-[350px] px-4 lg:p-2 pb-0 md:p-0">
                <ul className="relative w-full h-10 flex items-center justify-between gap-1 bg-neutral-800 lg:bg-[unset] rounded-xl md:rounded-2xl p-2 px-1 text-center font-sfr tracking-[.5px] *:w-1/3">
                    <li>
                        <button
                            onClick={() => handleType("short")}
                            className="justify-center w-full"
                        >
                            <p className="relative z-20 font-sft text-[.92rem] text-neutral-200">
                                Short
                            </p>
                        </button>
                    </li>
