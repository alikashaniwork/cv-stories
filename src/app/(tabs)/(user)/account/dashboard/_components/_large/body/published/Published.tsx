    ...
    return (
        <div>
            ...
            <ul className="grid grid-cols-3 gap-2 mt-2">
                ...
                <li className="h-24 flex flex-col justify-center bg-rose-500/5 backdrop-blur-xl rounded-2xl">
                    <Link
                ...
                <li className="h-24 flex flex-col justify-center bg-blue/5 rounded-2xl">
                    <Link
