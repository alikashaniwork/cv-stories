...
const Submit = ({ onClose }: { onClose: () => void }) => {
    ...
    return (
        <div className="w-[260px] h-28 rounded-xl bg-[#333]">
            <p className="w-full h-14 overflow-hidden text-ellipsis text-nowrap text-left text-sm font-sfr capitalize tracking-[.8px] p-4 border-b border-[#444] block">
